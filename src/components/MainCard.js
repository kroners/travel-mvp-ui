            ...
            <Grid container>
                ...
                <Grid item xs={6}>
                    <div className="program_search__main_right">
                        ...
                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam onumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. 
, Donumy eirmod tempor invidunt ut labore et dolore magna al.
Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam onumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. 
, Donumy eirmod tempor invidunt ut labore et dolore magna al.
                        </p>
                        <div className="program_search__main_right__extras">
                            ...
                            <div className="program_search__main_calificaciones">
                                ...
                                <p className="program_search__main_comentarios">555 comentario(s)</p>
                            </div>
                        </div>
                    </div>
                </Grid>
